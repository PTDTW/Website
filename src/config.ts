...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/PTDTW", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	avatar: "/avatar02.jpeg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "糖豆魚｜PTD",
	bio: "中華民國新北市，15歲國中生",
	links: [
		{
			...
			url: "https://discord.gg/bAuKcwCqwX",
		},
		{
			name: "GitHub",
